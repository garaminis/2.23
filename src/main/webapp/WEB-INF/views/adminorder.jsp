...
'<td>상품이름(goods_name)</td><td>수량(cnt)</td><td>금액(sales)</td>'+
'<td>받는사람(delname)</td><td>우편번호(delzipcode)</td><td>보낼주소(deladress)</td>'+
'<td>상세주소(deladress2)</td>'+
'<td>받는사람번호(delmobile)</td><td>요청사항(delreq)</td><td>배송방법(delivery_name)</td>'+
'<td>배송비(delivery_pay)</td><td>결제방법(payment_name)</td><td>진행상황(state)</td><td>주문날짜(created)</td><td>수정/삭제</td></tr>';
$(document)
.ready(function(){
